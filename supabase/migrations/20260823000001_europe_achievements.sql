...
INSERT INTO achievements (key, name_he, desc_he, icon, is_hidden) VALUES
  ('eu_first',    'לילה אירופי',      'נצח סיבוב אחד במוקדמות ליגת האלופות',              '🇪🇺', false),
  ('eu_playoff',  'עד הפלייאוף',      'הגע לסיבוב הרביעי - הפלייאוף',               '🎟', false),
  ('eu_group',    'שלב הליגה',        'עבור את הפלייאוף והעפל לשלב הליגה של ליגת האלופות', '🏆', false),
  ('eu_clean',    'בלי לספוג',        'עבור סיבוב שלם, בית וחוץ, בלי לספוג שער',           '🧤', false),
