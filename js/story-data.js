...
const STORY_CHAPTERS = [
    ...
    europe: {
      ...
      rounds: [
        { id: 'q',   label: 'הסיבוב המוקדם', kind: 'tie', firstHome: true,
          club: { name: 'אררט ירוואן', crest: 'eu-ararat-yerevan', flag: '🇦🇲', ovr: 74 }, real: 'בבית 3-0, בחוץ 2-0' },
        { id: 'r1',  label: 'הסיבוב הראשון', kind: 'tie', ko: true, firstHome: false,
          club: { name: 'גזיאנטפספור', crest: 'eu-gaziantep', flag: '🇹🇷', ovr: 81 }, real: 'בבית 1-0, בחוץ 1-1' },
        ...
        { id: 'r3',  label: 'הסיבוב השלישי', kind: 'tie', ko: true, firstHome: false,
          club: { name: 'לוקומוטיב מוסקבה', crest: 'eu-lokomotiv', flag: '🇷🇺', ovr: 89 }, real: 'בבית 2-1, בחוץ 1-0' },
        { id: 'r4',  label: 'שמינית הגמר', kind: 'tie', ko: true, firstHome: true,
          club: { name: 'פארמה', crest: 'eu-parma', flag: '🇮🇹', ovr: 91 }, real: 'בבית 0-0, בחוץ 2-1' },
    ...
    europe: {
      ...
      rounds: [
        { id: 'q2', label: 'סיבוב המוקדמות השני', kind: 'tie', firstHome: true,
          club: { name: 'בלשינה בוברויסק', crest: 'eu-belshina', flag: '🇧🇾', ovr: 72 }, real: 'בבית 4-0, בחוץ 1-0' },
        ...
        { id: 'group', label: 'שלב הבתים', kind: 'group', advance: 2,
          clubs: [{ name: 'מנצ\'סטר יונייטד', crest: 'eu-manutd', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', ovr: 97 },
  ...
  },
  {
    ...
    europe: {
      ...
      rounds: [
        { id: 'q2', label: 'סיבוב המוקדמות השני', kind: 'tie', firstHome: true,
          club: { name: 'גלנטורן', crest: 'eu-glentoran', flag: '🇬🇧', ovr: 70 }, real: 'בבית 6-0, בחוץ 4-0' },
        { id: 'q3', label: 'סיבוב המוקדמות השלישי', kind: 'tie', firstHome: false,
          club: { name: 'אקטובה', crest: 'eu-aktobe', flag: '🇰🇿', ovr: 78 }, real: 'בחוץ 0-0, בבית 4-3' },
        ...
        { id: 'group', label: 'שלב הבתים', kind: 'group', advance: 2,
          clubs: [{ name: 'באיירן מינכן', crest: 'eu-bayern', flag: '🇩🇪', ovr: 97 },
                  ...
                  { name: 'בורדו', crest: 'eu-bordeaux', flag: '🇫🇷', ovr: 93 }],
      ...
      rounds: [
        ...
        { id: 'clgroup', label: 'שלב הבתים של ליגת האלופות', kind: 'group', advance: 2, tier: 'ucl',
          ...
          clubs: [{ name: 'ברצלונה', crest: 'eu-barca', flag: '🇪🇸', ovr: 97 },
                  ...
                  { name: 'בורוסיה מנשנגלדבאך', crest: 'eu-gladbach', flag: '🇩🇪', ovr: 90 }],
        ...
        { id: 'group', label: 'שלב הבתים של הליגה האירופית', kind: 'group', advance: 2,
          clubs: [{ name: 'אינטר', crest: 'eu-inter', flag: '🇮🇹', ovr: 93 },
                  { name: 'סאות\'המפטון', crest: 'eu-southampton', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', ovr: 89 },
  ...
  },
  {
    ...
    europe: {
      ...
      rounds: [
        { id: 'q2', label: 'מוקדמות ליגת האלופות, סיבוב שני', kind: 'tie', firstHome: true,
          club: { name: 'ג\'יור', crest: 'eu-gyor', flag: '🇭🇺', ovr: 78 }, real: 'בבית 2-1, בחוץ 2-0' },
        ...
        { id: 'group', label: 'שלב הבתים של הליגה האירופית', kind: 'group', advance: 2,
          clubs: [{ name: 'בורדו', crest: 'eu-bordeaux', flag: '🇫🇷', ovr: 88 },
                  { name: 'אפואל', crest: 'eu-apoel', flag: '🇨🇾', ovr: 83 },
                  { name: 'איינטרכט פרנקפורט', crest: 'eu-frankfurt', flag: '🇩🇪', ovr: 88 }],
