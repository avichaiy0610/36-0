...
const EU_POTS_UEL = [
  [ // pot 1 — 89-93
    { id: 'eu-roma', name: 'רומא', flag: '🇮🇹', ovr: 95 },
    { id: 'eu-villarreal', name: 'ויאריאל', flag: '🇪🇸', ovr: 95 },
    { id: 'eu-betis', name: 'ריאל בטיס', flag: '🇪🇸', ovr: 94 },
    { id: 'eu-lyon', name: 'ליון', flag: '🇫🇷', ovr: 93 },
    { id: 'eu-fener', name: "פנרבחצ'ה", flag: '🇹🇷', ovr: 91 },
    { id: 'eu-ajax', name: 'אייאקס', flag: '🇳🇱', ovr: 92 },
    { id: 'eu-sociedad', name: 'ריאל סוסיאדד', flag: '🇪🇸', ovr: 94 },
    { id: 'eu-braga', name: 'בראגה', flag: '🇵🇹', ovr: 91 },
    { id: 'eu-rangers', name: "ריינג'רס", flag: '🏴', ovr: 89 },
  ],
  [ // pot 2 — 85-88
    { id: 'eu-galatasaray', name: 'גלאטסראיי', flag: '🇹🇷', ovr: 91 },
    { id: 'eu-nice', name: 'ניס', flag: '🇫🇷', ovr: 92 },
    { id: 'eu-hoffenheim', name: 'הופנהיים', flag: '🇩🇪', ovr: 93 },
    { id: 'eu-unionsg', name: "יוניון סן ז'ילואז", flag: '🇧🇪', ovr: 90 },
    { id: 'eu-slavia', name: 'סלביה פראג', flag: '🇨🇿', ovr: 90 },
    { id: 'eu-ferencvaros', name: 'פרנצווארוש', flag: '🇭🇺', ovr: 86 },
    { id: 'eu-paok', name: 'פאוק סלוניקי', flag: '🇬🇷', ovr: 88 },
    { id: 'eu-az', name: 'אלקמאר', flag: '🇳🇱', ovr: 91 },
    { id: 'eu-anderlecht', name: 'אנדרלכט', flag: '🇧🇪', ovr: 90 },
  ],
  [ // pot 3 — 82-84
    { id: 'eu-twente', name: 'טוונטה', flag: '🇳🇱', ovr: 90 },
    { id: 'eu-midtjylland', name: 'מידטיולנד', flag: '🇩🇰', ovr: 88 },
    { id: 'eu-plzen', name: 'ויקטוריה פלזן', flag: '🇨🇿', ovr: 89 },
    { id: 'eu-bodo', name: 'בודו/גלימט', flag: '🇳🇴', ovr: 88 },
    { id: 'eu-malmo', name: 'מאלמו', flag: '🇸🇪', ovr: 87 },
    { id: 'eu-lask', name: 'לאסק לינץ', flag: '🇦🇹', ovr: 88 },
    { id: 'eu-qarabag', name: 'קרבאח', flag: '🇦🇿', ovr: 85 },
    { id: 'eu-ludogorets', name: 'לודוגורץ', flag: '🇧🇬', ovr: 85 },
    { id: 'eu-besiktas', name: "בשיקטאש", flag: '🇹🇷', ovr: 90 },
  ],
  [ // pot 4 — 78-81. Your own pot, and the only place the table is winnable.
    ...
    { id: 'eu-rfs', name: 'ריגה', flag: '🇱🇻', ovr: 82 },
    { id: 'eu-backa', name: 'טי.אס.סי בקה טופולה', flag: '🇷🇸', ovr: 86 },
    { id: 'eu-aek-larnaca', name: 'איי.אי.קיי לרנקה', flag: '🇨🇾', ovr: 85 },
    { id: 'eu-slovacko', name: 'סלובאצקו', flag: '🇨🇿', ovr: 88 },
    { id: 'eu-petrocub', name: 'פטרוקוב', flag: '🇲🇩', ovr: 82 },
    { id: 'eu-noah', name: 'נוח ירוואן', flag: '🇦🇲', ovr: 82 },
  ],
];

const EU_POTS_UECL = [
  [ // pot 1 — 92-94
    { id: 'eu-fiorentina', name: 'פיורנטינה', flag: '🇮🇹', ovr: 96 },
    { id: 'eu-rapid', name: 'ראפיד וינה', flag: '🇦🇹', ovr: 90 },
    { id: 'eu-legia', name: 'לגיה ורשה', flag: '🇵🇱', ovr: 89 },
    { id: 'eu-gent', name: 'חנט', flag: '🇧🇪', ovr: 90 },
    { id: 'eu-djurgarden', name: 'יורגורדן', flag: '🇸🇪', ovr: 87 },
    { id: 'eu-heidenheim', name: 'היידנהיים', flag: '🇩🇪', ovr: 94 },
  ],
  [ // pot 2 — 89-91
    { id: 'eu-jagiellonia', name: 'יאגיילוניה', flag: '🇵🇱', ovr: 88 },
    { id: 'eu-cercle', name: "סרקל ברוז'", flag: '🇧🇪', ovr: 89 },
    { id: 'eu-vikingur', name: 'ויקינגור', flag: '🇮🇸', ovr: 82 },
    { id: 'eu-panathinaikos', name: 'פנאתינייקוס', flag: '🇬🇷', ovr: 89 },
    { id: 'eu-lugano', name: 'לוגאנו', flag: '🇨🇭', ovr: 88 },
    { id: 'eu-hearts', name: 'הארטס', flag: '🏴', ovr: 88 },
  ],
  [ // pot 3 — 86-88
    { id: 'eu-shamrock', name: 'שמרוק רוברס', flag: '🇮🇪', ovr: 84 },
    { id: 'eu-mlada', name: 'מלאדה בולסלב', flag: '🇨🇿', ovr: 88 },
    { id: 'eu-astana', name: 'אסטנה', flag: '🇰🇿', ovr: 86 },
    { id: 'eu-borac', name: 'בוראץ באניה לוקה', flag: '🇧🇦', ovr: 84 },
    { id: 'eu-heerenveen', name: 'הרנפן', flag: '🇳🇱', ovr: 90 },
    { id: 'eu-brondby', name: 'ברונדבי', flag: '🇩🇰', ovr: 88 },
  ],
  [ // pot 4 — 83-85
    { id: 'eu-omonia', name: 'אומוניה ניקוסיה', flag: '🇨🇾', ovr: 86 },
    { id: 'eu-larne', name: 'לארן', flag: '🇬🇧', ovr: 81 },
    { id: 'eu-pafos', name: 'פאפוס', flag: '🇨🇾', ovr: 86 },
    { id: 'eu-celje', name: 'צלייה', flag: '🇸🇮', ovr: 85 },
    { id: 'eu-tns', name: 'ניו סיינטס', flag: '🏴󠁧󠁢󠁷󠁬󠁳󠁿', ovr: 81 },
    { id: 'eu-hjk', name: 'הלסינקי', flag: '🇫🇮', ovr: 84 },
  ],
  [ // pot 5 — 80-82
    { id: 'eu-molde', name: 'מולדה', flag: '🇳🇴', ovr: 88 },
    { id: 'eu-olimpija', name: 'אולימפיה לובליאנה', flag: '🇸🇮', ovr: 85 },
    { id: 'eu-milsami', name: 'מילסמי אורחיי', flag: '🇲🇩', ovr: 82 },
    { id: 'eu-vitoria', name: 'ויטוריה גימאראש', flag: '🇵🇹', ovr: 91 },
    { id: 'eu-panevezys', name: 'פנבז\'יס', flag: '🇱🇹', ovr: 82 },
    { id: 'eu-backatopola', name: 'ראדניצקי', flag: '🇷🇸', ovr: 87 },
  ],
  [ // pot 6 — 78-79. Your own pot; the sixth seat of it is you.
    { id: 'eu-dinamo-minsk', name: 'דינמו מינסק', flag: '🇧🇾', ovr: 83 },
    { id: 'eu-st-gallen', name: 'סנט גאלן', flag: '🇨🇭', ovr: 87 },
    { id: 'eu-backa', name: 'טי.אס.סי בקה טופולה', flag: '🇷🇸', ovr: 87 },
    { id: 'eu-shelbourne', name: 'שלבורן', flag: '🇮🇪', ovr: 83 },
    { id: 'eu-paksi', name: 'פאקש', flag: '🇭🇺', ovr: 85 },
  ],
];
...
const EU_QUAL_CLUBS = {
  uel: {
    q1: [
      { id: 'eu-hibernians', name: "היברניאנס", country: "מלטה", flag: '🇲🇹', ovr: 80 },
      { id: 'eu-differdange', name: "דיפרדנז", country: "לוקסמבורג", flag: '🇱🇺', ovr: 81 },
      { id: 'eu-vllaznia', name: "ולאזניה", country: "אלבניה", flag: '🇦🇱', ovr: 82 },
    ],
    q2: [
      { id: 'eu-pyunik', name: "פיוניק ירוואן", country: "ארמניה", flag: '🇦🇲', ovr: 82 },
      { id: 'eu-paks', name: "פאקש", country: "הונגריה", flag: '🇭🇺', ovr: 84 },
      { id: 'eu-ordabasy', name: "אורדבאסי", country: "קזחסטן", flag: '🇰🇿', ovr: 84 },
    ],
    q3: [
      { id: 'eu-sabah', name: "סבאח באקו", country: "אזרבייג'ן", flag: '🇦🇿', ovr: 84 },
      { id: 'eu-zrinjski', name: "זרינסקי מוסטאר", country: "בוסניה", flag: '🇧🇦', ovr: 84 },
      { id: 'eu-levski', name: "לבסקי סופיה", country: "בולגריה", flag: '🇧🇬', ovr: 84 },
    ],
    po: [
      { id: 'eu-hajduk', name: "היידוק ספליט", country: "קרואטיה", flag: '🇭🇷', ovr: 87 },
      { id: 'eu-rijeka', name: "ריאקה", country: "קרואטיה", flag: '🇭🇷', ovr: 87 },
      { id: 'eu-besiktas', name: "בשיקטאש", country: "טורקיה", flag: '🇹🇷', ovr: 90 },
    ],
  },
  uecl: {
    q2: [
      { id: 'eu-hamrun', name: "המרון ספרטנס", country: "מלטה", flag: '🇲🇹', ovr: 81 },
      { id: 'eu-vaduz', name: "ואדוץ", country: "ליכטנשטיין", flag: '🇱🇮', ovr: 81 },
      { id: 'eu-sligo', name: "סלייגו רוברס", country: "אירלנד", flag: '🇮🇪', ovr: 82 },
    ],
    q3: [
      { id: 'eu-ararat', name: "אררט ארמניה", country: "ארמניה", flag: '🇦🇲', ovr: 82 },
      { id: 'eu-neman', name: "נמאן גרודנו", country: "בלארוס", flag: '🇧🇾', ovr: 83 },
      { id: 'eu-sheriff', name: "שריף טירספול", country: "מולדובה", flag: '🇲🇩', ovr: 83 },
    ],
    po: [
      { id: 'eu-zira', name: "זירה", country: "אזרבייג'ן", flag: '🇦🇿', ovr: 84 },
      { id: 'eu-astana', name: "אסטנה", country: "קזחסטן", flag: '🇰🇿', ovr: 86 },
      { id: 'eu-wisla', name: "ויסלה קרקוב", country: "פולין", flag: '🇵🇱', ovr: 87 },
    ],
  },
};
