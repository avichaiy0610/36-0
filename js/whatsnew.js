...
const WHATS_NEW = [
  {
    v: '1.51', date: '31.8.2026', title: 'תקרת שכר',
    items: [
      '💰 תקרת שכר — מצב חדש במסך ההגדרות: לכל שחקן יש מחיר, ורק הכוכבים עולים כסף. 90+ עולה ₪8מ׳, 86-89 עולה ₪5מ׳, 82-85 עולה ₪3מ׳, וכל מי שמדורג 81 ומטה חופשי. אי אפשר לחרוג — שחקן שאין לך כסף עבורו מסומן בקו ולא ניתן לבחירה.',
