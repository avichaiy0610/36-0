...
const TEXT_CATALOG = [
 ...
 {"key": "eu-sub", "screen": "אירופה - מסע העונה", "label": "שורת פתיחה", "selector": "virtual", "def": "ארבעה תיקים, כל אחד בית וחוץ. ההרכב שלך משחק כמו שהוא -"},
 ...
 {"key": "eu-phase-sub", "screen": "אירופה - מסע העונה", "label": "שלב הליגה - הסבר", "selector": "virtual", "def": "שמונה משחקים מול שמונה יריבות שונות - שתיים מכל סל, אחת בבית ואחת בחוץ."},
 ...
 {"key":"wn-1.2-date","screen":"מה חדש","label":"v1.2 · תאריך","selector":"virtual","def":"19.8.2026"},
 {"key":"wn-1.2-title","screen":"מה חדש","label":"v1.2 · כותרת","selector":"virtual","def":"מנוע סימולציה חדש"},
 {"key":"wn-1.2-items","screen":"מה חדש","label":"v1.2 · השורות (שורה לכל פריט)","selector":"virtual","def":"⚙️ מנוע V2 — התוצאה נקבעת לפי ארבעה קווים (שוער, הגנה, קישור, התקפה) ולא לפי דירוג אחד, כך שהרכב לא מאוזן מרגיש לא מאוזן.\n📈 פורמה עונתית לכל קבוצה, כך שאליפות באמת אפשר להפסיד.\n🎯 שחקן שמשחק מחוץ לעמדה הטבעית שלו שווה 93% — גם בסימולציה, לא רק בתצוגה."}
];
