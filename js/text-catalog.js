...
const TEXT_CATALOG = [
 ...
 {"key": "gt-desc-hapoel-tlv-2009-10", "screen": "גאונטלט — תיאורי יריבות", "label": "הפועל תל אביב 2009/10", "selector": "virtual", "def": "עונת הדאבל: אליפות שהוכרעה בדקה ה-92 במחזור האחרון, וסיום ראשון בבית בליגה האירופית."},
 {"key": "gt-desc-maccabi-tlv-2015-16", "screen": "גאונטלט — תיאורי יריבות", "label": "מכבי תל אביב 2015/16", "selector": "virtual", "def": "81 נקודות וסגנית — ערן זהבי כבש 35 שערים, שיא הליגה בעידן המודרני."},
 {"key": "gt-desc-maccabi-haifa-2001-02", "screen": "גאונטלט — תיאורי יריבות", "label": "מכבי חיפה 2001/02", "selector": "virtual", "def": "אלופה 22-9-2 — והתואר הזה שלח אותה להיות הישראלית הראשונה בשלב הבתים של ליגת האלופות."}
];
