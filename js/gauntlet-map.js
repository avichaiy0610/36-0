  ...
  return `
    <div class="gt-intro">
      ...
      <div class="gt-intro-relic">
        ...
        <p>חפץ שנשאר איתך עד סוף המסע ומשנה כלל אחד במשחק — למשל קהל בית שמחזק אותך בקרבות מסוימים, ניצחון מובטח בבעיטות ה-11, הצצה לדירוג היריבה הבאה, או החתמת שחקן בלי הגרלה. אין שניים זהים, ובחירה נכונה שווה יותר משחקן טוב אחד.</p>
        <p class="gt-soon">הקמעות עדיין בבנייה — כרגע ההגרלה מחלקת שחקנים בלבד.</p>
      </div>
