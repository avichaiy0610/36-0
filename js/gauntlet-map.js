...
// What happened to that club that season, in one word. The map is a climb from
// the bottom of the table to the top of it, and these are the rungs.
const GM_TAGS = { down: '🔻 ירדה ליגה', champ: '🥇 אלופה', second: '🥈 סגנית' };
...
function gmRoadPicker(at, over) {
  ...
  return `
    <div class="gm-picker">
      ${row.act ? `<div class="gm-picker-act">${row.act}</div>` : ''}
      ...
      ${row.nodes.map((n, ni) => {
        ...
        <button class="gm-road ${elite ? 'elite' : ''}" data-row="${at}" data-node="${ni}">
          ...
          <span class="gm-road-main">
            <span class="gm-road-club">${club} <span class="gm-road-season">${n.season}</span>
              ${tag ? `<span class="gm-road-tag ${n.tag}">${tag}</span>` : ''}</span>
            ${n.fin ? `<span class="gm-road-fin">${n.fin}</span>` : ''}
...
const GM_RUN = [
  { kind: 'fight', round: 1, act: 'הקרקעית', nodes: [
    { teamId: 'hapoel-aco',        season: '2017/18', ovr: 75, tag: 'down', fin: 'מקום 14/14 · 20 נק׳',
      desc: 'שש עונות בליגת העל נגמרו כאן: 6 ניצחונות, 23 הפסדים ו-67 ספיגות.' },
    { teamId: 'hapoel-kfar-saba',  season: '2020/21', ovr: 76, tag: 'down', fin: 'מקום 14/14 · 24 נק׳',
      desc: 'עונה של 21 הפסדים ו-26 שערים בלבד, שנגמרה בירידה.' },
    { teamId: 'hapoel-pt',         season: '2006/07', ovr: 76, tag: 'down', fin: 'מקום 12/12 · 16 נק׳',
      desc: 'שלושה ניצחונות בעונה שלמה. מקום אחרון בליגה של 12.' },
  ] },
  { kind: 'fight', round: 2, act: 'הקרקעית', nodes: [
    { teamId: 'hapoel-holon',      season: '2000/01', ovr: 77, tag: 'down', fin: 'מקום 12/12 · 16 נק׳',
      desc: '30 הפסדים ו-85 ספיגות: הפרש השערים הגרוע ביותר בכל ההיסטוריה של הדאטה, ‎−60.' },
  ...
  { kind: 'fight', round: 3, act: 'הקרקעית', nodes: [
    ...
    { teamId: 'hapoel-raanana',    season: '2019/20', ovr: 78, tag: 'down', fin: 'מקום 14/14 · 17 נק׳',
      desc: 'שני ניצחונות, מקום אחרון, והעונה האחרונה של רעננה בליגת העל.' },
    { teamId: 'hapoel-rishonim',   season: '2002/03', ovr: 79, tag: 'down', fin: 'מקום 12/12 · 18 נק׳',
      desc: 'מקום אחרון עם 18 נקודות, למרות שי הולצמן (85) בהרכב.' },
  ] },
  { kind: 'shop' },
  { kind: 'fight', round: 4, act: 'הנפילות הגדולות', nodes: [
    { teamId: 'bnei-sakhnin',      season: '2005/06', ovr: 80, tag: 'down', fin: 'מקום 12/12 · 25 נק׳',
      desc: 'שנתיים אחרי גביע המדינה, סכנין יורדת ליגה - עם עבאס סואן (85) על המגרש.' },
  ...
  { kind: 'fight', round: 5, act: 'הנפילות הגדולות', nodes: [
    { teamId: 'beitar-jerusalem',  season: '2010/11', ovr: 82, fin: 'מקום 11/16',
      desc: 'עונה אפורה של בית"ר במקום 11, עם טוטו תמוז (87) ואבירם ברוכיאן (85) בסגל.' },
    { teamId: 'hapoel-haifa',      season: '2017/18', ovr: 82, fin: 'מקום 4/14 · 62 נק׳',
      desc: 'מקום רביעי עם 62 נקודות - מהעונות הטובות של הפועל חיפה בעשור.' },
  ] },
  { kind: 'fight', round: 6, act: 'הנפילות הגדולות', nodes: [
    { teamId: 'hapoel-beersheba',  season: '2014/15', ovr: 85, fin: 'מקום 3/14 · 62 נק׳',
      desc: 'מקום שלישי עם 62 נקודות - העונה האחרונה לפני שושלת האליפויות.' },
    { teamId: 'hapoel-tlv',        season: '2009/10', ovr: 86, tag: 'champ', fin: 'אלופה · הפסד אחד',
      desc: 'הפסד אחד ב-35 משחקים, 87 שערים, אליפות ודאבל.' },
  ] },
  { kind: 'shop' },
  { kind: 'fight', round: 7, boss: true, act: 'השושלות', nodes: [
    { teamId: 'maccabi-tlv',       season: '2015/16', ovr: 86, tag: 'second', fin: 'סגנית · 81 נק׳',
      desc: 'ערן זהבי כבש 35 שערים בעונה הזאת. השני בטבלת הכובשים סיים על 14.' },
  ] },
  { kind: 'fight', round: 8, boss: true, act: 'השושלות', nodes: [
    { teamId: 'maccabi-haifa',     season: '2001/02', ovr: 88, tag: 'champ', fin: 'אלופה · 2 הפסדים',
      desc: 'שני הפסדים בכל העונה ויוסי בניון (91) בשיאו. הקיר האחרון.' },
  ] },
];
