...
KINDS = ['league', 'cup', 'ucl', 'uel', 'uecl', 'usc', 'isc']
...
def main():
    ...
    with io.open(OUT, 'w', encoding='utf-8', newline='\n') as f:
        f.write(
            ...
            '// Photographs of the trophies, cut out and shrunk to %dpx tall, inlined\n'
    ...
    print('\nwrote js/trophy-art.js — %d of %d kinds, %.1f KB total' % (len(art), len(KINDS), total / 1024))
